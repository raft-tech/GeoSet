...
| `GeoSetMultiMap/multiUtils.ts` | Shared utilities: slice config normalization, autozoom resolution, and three-phase (autozoom/eager/lazy) layer loading orchestration. |
