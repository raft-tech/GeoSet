...
export const flyoutColumns = {
  name: 'flyout_columns',
  config: {
    ...sharedControls.groupby,
    label: t('Extra data for Flyout'),
    default: [],
    renderTrigger: true,
    description: t(
      'List of extra columns made available for flyout. Flyout will not be visible if "JavaScript onClick href" is defined',
    ),
  },
};
...
export const iconType = {
  ...
  config: {
    ...
    clearable: false,
    default: 'circle',
    description: t('The icon for point type'),
    choices: [
      ['circle', t('Circle')],
      ['point', t('Point')],
      ['line', t('Line')],
