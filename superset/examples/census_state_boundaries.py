...
def load_census_state_boundaries(
    only_metadata: bool = False, force: bool = False
) -> None:
    tbl_name = "census_state_boundaries"
    ...
    with database.get_sqla_engine() as engine:
        ...
        if not only_metadata and (not table_exists or force):
            geojson = load_geojson_file("us_state_boundaries.geojson")
    ...
    if not tbl:
        ...
        db.session.add(tbl)
    tbl.description = "US Census state boundaries (polygons)"
