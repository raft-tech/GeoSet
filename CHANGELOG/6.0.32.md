...
> **Note:** This changelog only covers GeoSet-specific changes. For upstream Apache Superset changes, refer to the [Superset CHANGELOG](https://github.com/apache/superset/blob/master/CHANGELOG.md) in the official repository.
